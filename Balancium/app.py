...
def run_balance(user_input):
    try:
        equation = Equation(user_input)
        balanced_equation = equation.balance()
        return 'Balanced equation: ' + balanced_equation
    except IndexError:
...
def home():
    if request.method == 'POST':
        ...
        balanced_equation = run_balance(user_input)
        return render_template('result.html', balanced_equation=balanced_equation)
